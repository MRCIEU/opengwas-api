...
def test_clumping1(url, headers):
    ...
    r = requests.post(url + "/ld/clump", data=payload, headers={})
...
def test_matrix1(url, headers):
    payload = {'rsid': ['rs756190', 'rs7526762', 'rs7601028', 'rs7622475', 'rs9300092', 'rs9309995']}
    r = requests.post(url + "/ld/matrix", data=payload, headers={})
    o = r.json()
...
def test_ref_lookup1(url, headers):
    payload = {'rsid': ['rs234']}
    r = requests.post(url + "/ld/reflookup", data=payload, headers={})
    o = r.json()
